...
{
    public partial class InicialNumero2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsCompras", x => x.ItemCompraId);
                    table.ForeignKey(
                        name: "FK_ItemsCompras_Carritos_CarritoId",
                        column: x => x.CarritoId,
                        principalTable: "Carritos",
                        principalColumn: "CarritoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemsCompras_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "ProductoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsCompras_CarritoId",
                table: "ItemsCompras",
                column: "CarritoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsCompras_ProductoId",
                table: "ItemsCompras",
                column: "ProductoId");
